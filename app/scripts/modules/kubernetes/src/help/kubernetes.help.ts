...
const helpContents: { [key: string]: string } = {
  ...
  'kubernetes.manifest.patch.mergeStrategy': `
    ...
    <p><b>strategic</b>: <i>(Default)</i> <a href="https://github.com/kubernetes/community/blob/90e408affda2f6c97fec1195ab3b7aa554432227/contributors/devel/sig-api-machinery/strategic-merge-patch.md" target="_blank">Kubernetes Strategic merge patch.</a></p>
